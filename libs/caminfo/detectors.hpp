...
bool
detect_gopro(mp4utils::Mp4Stream& file, CameraInfo& info, bool metadata_only = false) noexcept;

bool
detect_insta360(mp4utils::Mp4Stream& file, CameraInfo& info, bool metadata_only = false) noexcept;
